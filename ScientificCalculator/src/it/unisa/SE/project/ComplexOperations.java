...
public class ComplexOperations {
    ...
    public static ComplexNumber scale(ComplexNumber num, double alpha) {
        if (num.equals(new ComplexNumber(0.0, 0.0))) {
            return num;
        } else if (num.getReal() == 0.0) {
            return new ComplexNumber(num.getReal(), alpha * num.getImaginary());
        } else if (num.getImaginary() == 0.0) {
            return new ComplexNumber(alpha * num.getReal(), num.getImaginary());
        }
