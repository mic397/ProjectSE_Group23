...
public class ComplexNumberTest {
    ...
    public void testDivToZero() {
        ComplexNumber.div(number1, number7);
    }
    ...
    public void testConjugate() {
        ...
        assertEquals(new ComplexNumber(number1.getReal(), number1.getImaginary() * (-1)), ComplexNumber.conjugate(number1));
        //re = 0 and im != 0
        number1.setReal(0.0);
        number1.setImaginary(1.0);
        assertEquals(new ComplexNumber(number1.getReal(), number1.getImaginary() * (-1)), ComplexNumber.conjugate(number1));
        ...
        assertEquals(number1, ComplexNumber.conjugate(number1));
    }
    ...
    public void testReciprocalNull() throws notAcceptableValueException {
        ...
        number1.setReal(0.0);
        number1.setImaginary(0.0);
        ComplexNumber.reciprocal(number1);
    }
    ...
    public void testReciprocal() throws notAcceptableValueException {
        ...
        assertEquals(number2, ComplexNumber.reciprocal(number1));

        number1.setReal(2.0);
        number1.setImaginary(1.0);
        number2.setReal(1.0);
        number2.setImaginary(0.0);
        ComplexNumber res = ComplexNumber.div(number2, number1);
        assertEquals(res, ComplexNumber.reciprocal(number1));
    }
